        ...
        <div class="rounded-xl border bg-white p-6 shadow-sm">
            ...
            <form method="POST" action="{{ route('admin.campaigns.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="body" rows="10" class="w-full rounded-lg border px-3 py-2 text-sm" data-rich-text data-placeholder="Write the newsletter content...">{{ old('body') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <select name="audience" class="w-full rounded-lg border px-3 py-2 text-sm">
                        ...
                        <option value="sellers" {{ old('audience') === 'sellers' ? 'selected' : '' }}>Creators</option>
