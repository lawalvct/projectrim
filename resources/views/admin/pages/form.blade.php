        ...
        <form method="POST" action="{{ isset($page) ? route('admin.pages.update', $page) : route('admin.pages.store') }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="body" rows="12" class="w-full rounded-lg border px-3 py-2 text-sm" data-rich-text data-placeholder="Write the page content...">{{ old('body', $page->body ?? '') }}</textarea>
